...
class Product(models.Model):
    ...
    def save(self, force_insert=False, force_update=False, using=None,
        ...
        if not self.stripe_product_price_id:
            stripe_product_price_response = self.create_stripe_product_price()
            self.stripe_product_price_id = stripe_product_price_response['id']
...
class Basket(models.Model):
    ...
    def de_json(self):
        basket_item = {
            ...
            'sum': float(self.sum()*self.quantity)
        }
        return basket_item
